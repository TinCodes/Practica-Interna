...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        ...
        \Illuminate\Support\Facades\DB::table('users')->insert([
           ...
           ['nombre' => 'Alejandra', 'rol' => '2', 'email' => 'camiloayzab@gmail.com', 'cargo'=> '3', 'campus'=> '2', 'password' => '$2b$10$Jwaos.KCEOx67vMBsPjsA.4xf9i/LOb6O0K2H9ZVkriz4Ea7T3F86',  'created_at' => now(), 'updated_at' => now()]
        ]);
    }
    /**
