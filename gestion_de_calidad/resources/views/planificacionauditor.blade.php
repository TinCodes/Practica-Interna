    ...
    <form method="post" action="/actividades">
        ...
        <div class="form-row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre de actividad" value="{{old('nombre')}}" required>
        ...
        <div class="form-row">
            ...
            <input type="text" class="form-control" id="auditor" name="auditor" placeholder="Auditor" value="{{ $currentAud }}" required>
