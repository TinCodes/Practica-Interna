...
<div class="container p-5">
    <form method="post" action="/auditorias/{{ $auditoria->id }}">
        @csrf
        @method('PATCH')
        <div class="form-row">
            <div class="col">
                <label for="nombre">Nombre de la auditoría:</label>
                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre de auditoria" value="{{ $auditoria->nombre }}" required>
        ...
        <div class="form-row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="fecha" name="fecha" placeholder="Fecha" value="{{ $auditoria->fecha }}" required>
                @error('fecha') <p class="valError"> {{ $message }} </p> @enderror
            </div>

            <div class="col-md-6 mb-3">
                <label for="pdc">Persona de contacto: </label>
                <input type="text" class="form-control" id="pdc" name="pdc" placeholder="Persona de contacto" value="{{ $auditoria->pdc }}" required>
        ...
        <div class="form-row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="macroproceso" name="macroproceso" placeholder="Macroproceso" value="{{ $auditoria->macroproceso }}" required>
                @error('macroproceso') <p class="valError"> {{ $message }} </p> @enderror
            </div>

            <div class="col-md-6 mb-3">
                <label for="proceso">Proceso: </label>
                <input type="text" class="form-control" id="proceso" name="proceso" placeholder="Proceso" value="{{ $auditoria->proceso }}" required>
        ...
        <div class="form-row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="auditor" name="auditor" placeholder="Auditor" value="{{ $auditoria->id_auditor }}" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <select class="form-control" id="elem_calidad" name="elem_calidad" required>
                    <option value="{{ $auditoria->elem_calidad }}"> {{ $auditoria->elem_calidad }} </option>
